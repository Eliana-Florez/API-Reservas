...
var bookingsRoutes = /** @class */ (function () {
    function bookingsRoutes() {
        this.router = (0, express_1.Router)();
        this.routes();
    }
    bookingsRoutes.prototype.getReserva = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var reservas;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, bookings_1.default.find()];
                    case 1:
                        reservas = _a.sent();
                        res.json(reservas);
                        return [2 /*return*/];
    ...
    bookingsRoutes.prototype.postReserva = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        newReserva = new bookings_1.default(req.body);
...
var bookingRoutes = new bookingsRoutes();
exports.default = bookingRoutes.router;
